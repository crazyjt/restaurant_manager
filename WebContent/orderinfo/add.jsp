...
<HTML>
	...
	<body style="overflow-y: visible;">
		...
		<s:form action="addOrder" validate="true">
			<div class="addTitle">
				添加订单
			</div>
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<tr width="100%">
						<td width="33%" style="text-align: center;" colspan="2">菜名</td>
						<td width="33%" style="text-align: center;">剩余份数</td>
						<td width="33%" style="text-align: center;">下单份数</td>
					</tr>
					<s:iterator value="allMenus">
						<tr>
							<td width="33%" style="text-align: center;border: 1px solid #8ba7e3;" colspan="2"><s:property value="m_name"></s:property></td>
							<td width="33%" style="text-align: center;border: 1px solid #8ba7e3;"><s:property value="m_inventory"></s:property></td>
							<td width="33%" style="text-align: center;border: 1px solid #8ba7e3;"><s:textfield name="m_order"></s:textfield></td>
						</tr>
					</s:iterator>
					<tr width="100%">
						<td class="ta_01" style="WIDTH: 100%;height: 5px;" align="center" bgColor="#f5fafe" colSpan="4">
							<div class="addBottom">
